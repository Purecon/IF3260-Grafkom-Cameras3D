...
function main() {
  ...
  // Setup a ui.
  setupSlider("#targetAngle", {value: radToDeg(targetAngleRadians), slide: updateTargetAngle, min: -360, max: 360});
  setupSlider("#targetHeight", {value: target[1], slide: updateTargetHeight, min: 50, max: 300});
